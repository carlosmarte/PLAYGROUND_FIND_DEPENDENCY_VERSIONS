...
"""Interactive REPL front-end — a thin shell over the SDK.
    ...
    cli.py (this REPL)  ->  sdk.PoetryVersionsSDK  ->  main.py
...
external caller can do by driving the same ``sdk.PoetryVersionsSDK`` directly.
...
class PoetryVersionsREPL(cmd.Cmd):
    intro = (
    ...
    def __init__(self, client=None):
        ...
        self.sdk = client or sdk.PoetryVersionsSDK()
    ...
    def do_registry(self, arg):
        ...
        print(f"index-url = {self.sdk.effective_index_url() or '(poetry default)'}")
    ...
    def do_show(self, arg):
        ...
        print(f"  output    = {self.cfg.output}")
        print(f"  venv-dir  = {self.cfg.venv_dir}")
        print(f"  poetry    = {self.cfg.poetry_version}")
        print(f"  verbose   = {'on' if self.cfg.verbose else 'off'}")

    def do_env(self, arg):
        """env  — show the resolved poetry/TLS env vars (os.environ or default)."""
    ...
    def do_find(self, arg):
        ...
        except sdk.PoetryVersionsError as e:
            print(e)
